...
export class Utilities {
    ...
    public static readonly noNetworkMessageCaption =
      "Отсутствует связь с сервером";
    public static readonly noNetworkMessageDetail =
      "Невозможно подключиться к серверу. Проверьте подлючение к локальной сети и/или к Интернету.";
    public static readonly accessDeniedMessageCaption = 
      "Доступ запрещен!";
