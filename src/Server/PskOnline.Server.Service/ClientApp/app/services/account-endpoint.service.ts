...
export class AccountEndpoint extends EndpointFactory {
  ...
  private readonly _passwordResetStart: string = "/api/account/reset-password-start";
  private readonly _passwordReset: string = "/api/account/reset-password";
  ...
  get passwordResetStartUrl() { return this.configurations.baseUrl + this._passwordResetStart; }
  get passwordResetUrl() { return this.configurations.baseUrl + this._passwordReset;}
  ...
  resetPasswordStartEndpoint(forgotRequest: ForgotPassword): any {

    return this.http.post<any>(this.passwordResetStartUrl, forgotRequest, this.getRequestHeadersNoAuth())
      .catch(error => {
        return this.handleError(error, () => this.resetPasswordStartEndpoint(forgotRequest));
      });
  }

  doResetPasswordEndpoint(requestModel: ResetPassword): any {
    return this.http.post<any>(this.passwordResetUrl, requestModel, this.getRequestHeadersNoAuth())
      .catch(error => {
        return this.handleError(error, () => this.doResetPasswordEndpoint(requestModel));
      });
  }
}