...
export type RolesChangedEventArg = { roles: UserRoleDetail[] | string[], operation: RolesChangedOperation };
...
export class AccountService {
  ...
  resetPasswordStart(userNameOrEmail: string): any {
    var request = new ForgotPassword(userNameOrEmail);
    return this.accountEndpoint.resetPasswordStartEndpoint(request);
  }

  doResetPassword(requestModel: ResetPassword): any {
    return this.accountEndpoint.doResetPasswordEndpoint(requestModel);
  }
  ...
  private onRolesChanged(roles: UserRoleDetail[] | string[], op: RolesChangedOperation) {
    this._rolesChanged.next({ roles: roles, operation: op });
  }

  onRolesUserCountChanged(roles: UserRoleDetail[] | string[]) {
