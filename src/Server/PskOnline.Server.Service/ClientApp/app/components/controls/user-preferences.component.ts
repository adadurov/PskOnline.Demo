...
export class UserPreferencesComponent implements OnInit, OnDestroy {
    ...
    setAsDefaultHelper() {
        this.alertService.startDelayedMessage("", "Saving new defaults");
    ...
    resetDefaultHelper() {
        this.alertService.startDelayedMessage("", "Resetting defaults");
  ...
  get canViewConfiguration() {
    return this.accountService.userHasPermission(Permission.manageTenantOrgStructurePermission) ||
      this.accountService.userHasPermission(Permission.manageTenantsPermission) ||
      ...
      this.accountService.userHasPermission(Permission.manageGlobalRolesPermission) ||
      this.accountService.userHasPermission(Permission.manageGlobalUsersPermission) ||
      this.accountService.userHasPermission(Permission.manageTenantsPermission) ||
      this.accountService.userHasPermission(Permission.manageTenantsPermission);
  }
}
