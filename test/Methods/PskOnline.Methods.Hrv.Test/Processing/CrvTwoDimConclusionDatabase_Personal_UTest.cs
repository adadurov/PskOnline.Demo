namespace PskOnline.Methods.Hrv.Test.Processing
{
  ...
  [TestFixture]
  public class CrvTwoDimConclusionDatabase_Personal_UTest
  {
    log4net.ILog log = log4net.LogManager.GetLogger(typeof(CrvTwoDimConclusionDatabase_Personal_UTest));
    ...
    [Test]
    public void Test_User_Conclusions()
    {
      TestTwoDimConclusionDb(new CrvTwoDimConclusionDatabase_Personal(), new System.Globalization.CultureInfo[] { ru, en });
    }
